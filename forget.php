...
<body style="background:linear-gradient(to left,grey,black);">
	...
	<div class="login" style="background-color: rgba(0,2,2,0.8);"> 
		...
		<input type="password" name="npassword1" minlength="6" placeholder="Enter new Password" required>
		<input type="password" name="npassword2" minlength="6" placeholder="Enter new Password" required>
		<input type="submit" name="forget" value="Update">
		<p>
