...
<body style="background-image: url(img/CHEM.jpg); ">
<p><?php 
...
<div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card card_color">
                    ...
                    <table class="records" border="1" align="center" cellpadding="10" cellspacing="10" style="padding:2px;border-style: double;border-color: cornsilk;">
                        <tr>
                            ...
                            <th style="text-align: center;padding: 3px;">JournalID</th>
                            <th style="text-align: center;padding: 3px;">Comment</th>
                        </tr>
                        ...
                        $journal_id = $row['j_id'];
                        $comment = $row['comment'];
                        echo "<tr><td style='text-align: center;padding: 3px;'>".$i."</td><td style='text-align: center;padding: 3px;'>".$journal_id."</td><td style='text-align: center;padding: 3px;'>".$comment."</td><td></tr>";
                        } 
                        mysqli_close($db);
                        ?>
                ...
                <a href="rinsert.php"><button type="button" class="btn-style btn-margin" style="border-style: none;border-radius: 10%;background-color: dodgerblue;opacity: 1;color: white;width: auto;margin-left: 250px;">Review</button></a>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card card_color">
                    ...
                    <ul type="none">
                        ...
                        <li><a href="rarchive.php" style="color: white">Recently Reviewed Papers</li>
                    </ul>
                </div>
            </div>
        </div>
